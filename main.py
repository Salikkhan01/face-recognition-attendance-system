            ...
            if matches[matchIndex]:
                ...
                if counter != 0:
                    ...
                    if counter == 1:
                        ...
                        # Get student data from Firebase Realtime DB
                        studentInfo = db.reference(f'Students/{id}').get()

                        print(studentInfo)

                        # Load image locally instead of Firebase Storage
                        imgStudent = cv2.imread(f'images/{id}.jpg')
